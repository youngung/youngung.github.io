    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-전보혜-학생이-독일-rwth-aachen-아헨공대-의-port-to-europe-postdoc-fellowship에-선정되었습니다-clap",
          title: '전보혜 학생이 독일 RWTH Aachen(아헨공대)의 ‘Port to Europe’ Postdoc Fellowship에 선정되었습니다. :clap:',
          description: "",
