...
- [4. Newton 보정량의 기하학적 의미](#4-newton-보정량의-기하학적-의미)
  - [4.1. 첫 번째 반복을 직접 계산하기](#41-첫-번째-반복을-직접-계산하기)
- [\\mathbf x^{(1)}](#mathbf-x1)
- [\\begin{bmatrix}0.625\\0.625\\end{bmatrix}](#beginbmatrix06250625endbmatrix)
- [5. Python 시각화](#5-python-시각화)
  - [5.1. 영점 곡선과 반복 경로](#51-영점-곡선과-반복-경로)
  - [5.2. 3차원 곡면과 $z=0$ 평면](#52-3차원-곡면과-z0-평면)
- [6. 주의할 점](#6-주의할-점)
- [7. 연습문제](#7-연습문제)
  - [연습문제 1](#연습문제-1)
  - [연습문제 2](#연습문제-2)
