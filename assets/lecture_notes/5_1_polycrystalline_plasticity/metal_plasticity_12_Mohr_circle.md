...
- 반지름
$$
R=\sqrt{\bigg(\frac{\sigma_{11}-\sigma_{22}}{2}\bigg)^2+\sigma_{12}^2}
$$
...
이다. 전단응력축의 양의 방향과 실제 요소의 회전방향은 교재마다 다를 수 있으므로 사용하는
부호 관례를 먼저 확인한다. 실제 요소가 $\theta$만큼 회전하면 Mohr 원에서는 크기가
$2\theta$인 각만큼 이동한다.
