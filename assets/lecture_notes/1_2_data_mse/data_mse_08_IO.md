...
- [2. 개념](#2-개념)
- [3. 예시](#3-예시)
  - [3.1. 예시 - 화면에 출력, 기보드로 입력](#31-예시---화면에-출력-기보드로-입력)
  - [3.2. 예시 - 입력된 값을 모두 더하기](#32-예시---입력된-값을-모두-더하기)
  - [3.3. 예시 - 위 예시를 바꿔서, 입력된 총 값의 평균을 구하는 Script를 작성해보자.](#33-예시---위-예시를-바꿔서-입력된-총-값의-평균을-구하는-script를-작성해보자)
  - [3.4. 예시 - 텍스트 파일 **쓰기**](#34-예시---텍스트-파일-쓰기)
  - [3.5. 예시 - 텍스트 파일 **읽기**](#35-예시---텍스트-파일-읽기)
  - [3.6. 예시 - 성적 처리](#36-예시---성적-처리)
  - [3.7. 예시 - 여러 파일을 대상으로 반복하기.](#37-예시---여러-파일을-대상으로-반복하기)
  - [3.8. 예시 - 모든 파일의 이름 바꾸기](#38-예시---모든-파일의-이름-바꾸기)
- [4. 문자열 포매팅](#4-문자열-포매팅)
  - [4.1. 퍼센트 (%) 방식](#41-퍼센트--방식)
  - [4.2. ~~str.format()~~는 다루지 않겠다.](#42-strformat는-다루지-않겠다)
  - [4.3. f-string](#43-f-string)
  - [4.4. 파일 쓰기 연습](#44-파일-쓰기-연습)
  - [4.5. 파일 읽기 연습](#45-파일-읽기-연습)
